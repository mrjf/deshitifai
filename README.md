...
For most projects, use one of these:

- Cloudflare Pages for static hosting, custom domains, preview deploys, and CDN performance.
- GitHub Pages for simple repository-backed static publishing.

## Domain defaults

If the project needs a new domain, use the skill to choose a name, check availability, purchase it through the user's preferred registrar, configure DNS, enable HTTPS, and verify the deployed site.
